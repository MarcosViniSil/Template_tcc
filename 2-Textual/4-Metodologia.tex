...
\begin{itemize}
    \item \textbf{Textos gerais}: textos de domínio conversacional e informal com média de 6 palavras por sentença;

    \item \textbf{Textos específicos}: textos associados a domínios especializados, como a área de tecnologia da informação com média de 6 palavras por sentença.
...
Com o objetivo de garantir um ambiente controlado e uniforme para a comparação entre os modelos de tradução, será utilizado um computador pessoal que não está mais em utilização, este sendo responsável pela execução de todos os testes a fim de garantir um ambiente justo entre os modelos propostos.

A Tabela \ref{tab:ambiente_computacional} apresenta as especificações do hardware utilizado nos experimentos:

\begin{table}[H]
\centering
\begin{tabular}{ |p{3cm}|p{3cm}|p{3cm}|p{3cm}| }
\hline
\multicolumn{1}{|p{3cm}|}{\centering\textbf{Memória RAM}} & \multicolumn{1}{p{3cm}|}{\centering\textbf{Processador}} & \multicolumn{1}{p{3cm}|}{\centering\textbf{Armazenamento}} & \multicolumn{1}{p{3cm}|}{\centering\textbf{Sistema operacional}} \\
\hline
\multicolumn{1}{|p{3cm}|}{\centering 16 GB DDR3} & \multicolumn{1}{p{3cm}|}{\centering i5 3470} & \multicolumn{1}{p{3cm}|}{\centering SSD 256 GB} & \multicolumn{1}{p{3cm}|}{\centering Ubuntu server 26.04} \\
\hline
\end{tabular}
...
A figura \ref{fig:procedimento} demostra os passos para a realização dos testes e coleta dos dados
...
Durante o processo de seleção, serão removidos dados que apresentem inconsistências que possam comprometer a avaliação dos modelos, tais como, caracteres inválidos, símbolos não pertencentes ao idioma de destino, excesso de espaços em branco e quebras de linha desnecessárias.
