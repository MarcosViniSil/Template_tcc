...
neurais recorrentes (RNN) \cite{build-llms-from-scratch-book}.
...
diversas tarefas de processamento de linguagem natural \cite{build-llms-from-scratch-book}.
...
sequência na arquitetura Transformer \cite{DBLP:journals/corr/VaswaniSPUJGKP17}.
...
diferentes idiomas apresentam diferentes organizações sintáticas \cite{DBLP:journals/corr/VaswaniSPUJGKP17}.
...
(\textit{keys}) e valores (\textit{values}) \cite{DBLP:journals/corr/VaswaniSPUJGKP17}.
...
de forma paralela \cite{liu2021multi}.
...
denominado \textit{head} \cite{liu2021multi}.
...
enriquecer as representações vetoriais geradas pela etapa anterior \cite{build-llms-from-scratch-book}.
...
informações importantes ao longo das camadas do modelo \cite{build-llms-from-scratch-book}.
